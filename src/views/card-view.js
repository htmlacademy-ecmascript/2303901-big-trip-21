...
class CardView extends View {
  ...
  createDestinationHtml() {
    ...
    const selectedType = types.find((type) => type.isSelected).value;
    const selectedDestination = destinations.find((destination) => destination.isSelected).name;

    return html`
      <h3 class="event__title">${selectedType} ${selectedDestination}</h3>
    `;
  }
